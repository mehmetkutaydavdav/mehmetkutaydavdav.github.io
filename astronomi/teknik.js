...
(() => {
  ...
  by('pluton').modelNote='New Horizons MVIC renk mozaiği (PIA11707) küreye kaplandı. Çözünürlük konuma göre değişir; güneydeki siyah alanlar gözlem eksikliğidir, gerçek koyu arazi değildir. Ortak boyut ölçeği ve gerçek zamanlı dönüş kullanılmaz.';
})();
